...
<p style="font-size: 14px">My research broadly spans Machine Learning, but my current focus is using deep learning for image restoration and interpolation, particularly in the medical domain. My interest in biomedical AI also extends broadly, where I have interest and experience studying <b>intelligence grounding</b>, through <b>Transfer Learning</b>, and <b>Learning Representations</b>.
</p>
...
<ul style="list-style-type:disc; margin-top:-2px">
  <li><p style="margin-bottom:5px; font-size: 14px"><b>May</b>: My advisor, Dr. Ipek Oguz, was honored as a <a href="https://news.vanderbilt.edu/2025/05/01/11-vanderbilt-faculty-members-selected-as-2025-chancellor-faculty-fellows/" target="_blank">Chancellor Faculty Fellow</a>! Congratulations Ipek!! </p></li>
...
<ul style="list-style-type:disc; margin-top:-2px">
  ...
  <li><p style="margin-bottom:5px; font-size: 14px"><b>October</b>: Our paper <i><a href="https://arxiv.org/abs/2310.05378" target="_blank">"Transcending the Attention Paradigm: Representation Learning from Geospatial Social Media Data"</a></i> is on arXiv!</p></li>
...
<ul style="list-style-type:disc; margin-top:-2px">
  <li><p style="margin-bottom:5px; font-size: 14px"><b>December</b>: Our paper <i><a href="https://arxiv.org/abs/2212.05116" target="_blank">"Leveraging Contextual Data Augmentation for Generalizable Melanoma Detection"</a></i> is on arXiv!</p></li>
  <li><p style="font-size: 14px"><b>December</b>: My paper <i><a href="https://arxiv.org/abs/2304.00002" target="_blank">"Beyond Interpretable Benchmarks: Contextual Learning through Cognitive and Multimodal Perception"</a></i> is on arXiv!</p></li>
</ul>
